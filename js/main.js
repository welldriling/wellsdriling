...
(function () {
  ...
  var I18N = {
    ar: {
      ...
      "services.title": "كل ما يحتاجه بئرك… من أول دراسة إلى آخر قطرة",
      ...
      "why3.d": "آبار تدوم لعقود، أسعار شفافة، وضمان على الأشغال.",
    ...
    fr: {
      ...
      "services.title": "Tout ce que votre puits exige… de la première étude à la dernière goutte",
      ...
      "why3.d": "Des puits qui durent des décennies, des prix transparents et des travaux garantis.",
    ...
    en: {
      ...
      "services.title": "Everything your well needs… from the first study to the last drop",
      ...
      "why3.d": "Wells that last for decades, transparent prices and guaranteed work.",
